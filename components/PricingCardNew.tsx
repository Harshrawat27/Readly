...
export default function PricingCardNew({ 
  ...
  const monthlyPrice = isYearlyPlan ? (plan.price / 12).toFixed(0) : plan.price.toString();
  ...
  const getButtonText = () => {
    ...
    return isPopular ? 'Get Max plan' : `Get ${plan.name === 'pro' ? 'Pro' : 'Ultimate'} plan`;
  };
  ...
  return (
    <div className={`relative bg-[#2a2a2a] rounded-2xl p-6 transition-all duration-200 hover:bg-[#303030] ${
            ...
            {!isPopular ? (
              ...
              <div>
                ...
                <div className="text-3xl font-bold text-white">
                  USD {monthlyPrice}
                  <span className="text-base font-normal text-gray-400">
                    {isYearlyPlan ? ' / month billed annually' : ' / month billed monthly'}
                  </span>
                </div>
              </div>
            )}
      ...
      <div className="space-y-3">
        <div className="text-sm font-medium text-gray-300 mb-3">
          {isFreePlan ? 'What you get:' : isPopular ? 'Everything in Pro, plus:' : 'Everything in Free and:'}
        </div>
        ...
        <div className="space-y-3 text-sm text-gray-300">
          {isFreePlan ? (
            ...
            <>
              ...
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-3 text-blue-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
