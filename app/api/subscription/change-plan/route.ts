  ...
  try {
    ...
    if (newPlanName === 'free') {
      ...
      try {
        ...
        return NextResponse.json({
          success: true,
          message: `Your subscription will be cancelled at the end of your billing cycle (${new Date(
            currentSub.currentPeriodEnd
          ).toLocaleDateString()}). You'll continue to have access to your current features until then.`,
          planChange: {
